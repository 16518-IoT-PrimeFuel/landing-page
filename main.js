document.addEventListener('DOMContentLoaded', () => {
    ...
    const I18N = {
        es: {
            ...
            'problem.p4.meta':  'Parada de obra',
            ...
            'sensors.title':    'Sensores IoT que anticipan el desabastecimiento',
            'sensors.subtitle': 'Hoy el abastecimiento depende de que alguien detecte manualmente cu\u00e1ndo el tanque est\u00e1 por agotarse. FullTank lo automatiza con sensores inteligentes instalados en campo.',
            ...
            'sensors.flow2.title': 'Alerta al cruzar el umbral',
            'sensors.flow2.text':  'Cuando el nivel cae por debajo del umbral configurado (por ejemplo, 20%), el comprador recibe una alerta inmediata.',
            'sensors.flow3.title': 'Pedido autom\u00e1tico',
            'sensors.flow3.text':  'Si el comprador tiene un proveedor favorito, FullTank genera la solicitud de pedido autom\u00e1ticamente. Si no, la alerta queda esperando su decisi\u00f3n manual.',
            ...
            'sensors.data.title': 'Datos que se convierten en predicci\u00f3n',
            'sensors.data.text':  'El historial de consumo por cliente es un activo estrat\u00e9gico: permite desarrollar modelos predictivos que anticipan cu\u00e1ndo un usuario necesitar\u00e1 abastecimiento antes de alcanzar niveles cr\u00edticos, reduciendo el desabastecimiento y mejorando la planificaci\u00f3n del suministro.',
        ...
        en: {
            ...
            'problem.p4.meta':  'Jobsite shutdown',
            ...
            'sensors.title':    'IoT sensors that anticipate fuel shortages',
            'sensors.subtitle': 'Today, refueling depends on someone manually noticing when the tank is about to run dry. FullTank automates it with smart sensors deployed in the field.',
            ...
            'sensors.flow2.title': 'Alert when the threshold is crossed',
            'sensors.flow2.text':  'When the level drops below the configured threshold (for example, 20%), the buyer receives an immediate alert.',
            'sensors.flow3.title': 'Automatic order',
            'sensors.flow3.text':  'If the buyer has a favorite supplier, FullTank generates the order request automatically. If not, the alert waits for their manual decision.',
            ...
            'sensors.data.title': 'Data that becomes prediction',
            'sensors.data.text':  'Per-client consumption history is a strategic asset: it enables predictive models that anticipate when a user will need refueling before reaching critical levels, reducing shortages and improving supply planning.',
